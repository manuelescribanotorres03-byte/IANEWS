...
5. Hacer commit y push a la rama de trabajo (`claude/zen-brown-xcdcor`,
   o la rama indicada en las instrucciones de la sesión — si cambia de una
   sesión a otra, actualiza también el enlace de este archivo para que
   siga apuntando a la rama donde realmente se sobrescribe `hoy.md`).
6. Enviar una notificación push (PushNotification) con el siguiente formato
   ...
   - **Enlace al resumen completo** (OBLIGATORIO, siempre en la segunda posición):
     https://github.com/manuelescribanotorres03-byte/ianews/blob/claude/zen-brown-xcdcor/hoy.md
