...
5. Hacer commit y push a la rama de trabajo indicada en las instrucciones de
   la sesión (la rama concreta puede cambiar de una sesión a otra; usa
   siempre la que las instrucciones de la sesión designen, y actualiza el
   enlace de abajo si cambia).
