...
5. Hacer commit y push a la rama de trabajo (`claude/zen-brown-syedmd`,
   o la rama indicada en las instrucciones de la sesión — si la sesión indica
   una rama distinta a la de aquí abajo, esa rama manda, y este archivo debe
   actualizarse para reflejarla en la siguiente ejecución).
6. Enviar una notificación push (PushNotification) con el siguiente formato
   ...
   - **Enlace al resumen completo** (OBLIGATORIO, siempre en la segunda posición):
     https://github.com/manuelescribanotorres03-byte/ianews/blob/claude/zen-brown-syedmd/hoy.md
